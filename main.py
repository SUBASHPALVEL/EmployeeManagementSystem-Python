...
root = Tk()
root.title("Employee Management System By SUBASH")
...
# 6 Setting title and label
                                                             # for title                                        
title = Label(entries_frame, text="Employee Management System By SUBASH", font=("Calibri", 20, "bold"), bg="#535c68", fg="white")
